...
module.exports = {
  ...
  description: "Thiết lập âm lượng mặc định của sever cho bot", //the command description for helpcmd [OPTIONAL]
    ...
    try {
      ...
      return message.reply({
        embeds: [
          ...
          .setColor(ee.color)
          .setFooter(ee.footertext, ee.footericon)
          .setTitle(`${client.allEmojis.check_mark} **Volume mặc định hiện nay là: \`${volume}\`!**`)
        ],
      })
    } catch (e) {
