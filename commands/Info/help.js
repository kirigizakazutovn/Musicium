...
module.exports = {
  ...
  description: "Trả lại tất cả các lệnh/một lệnh nào đó", //the command description for helpcmd [OPTIONAL]
    ...
    try {
      ...
      if (args[0] && args[0].length > 0) {
        ...
        const embed = new MessageEmbed()
          ...
          .setDescription(`**[Mời tớ với lệnh sổ chéo với tất cả các quyền](https://discord.com/api/oauth2/authorize?client_id=${client.user.id}&permissions=8&scope=bot%20applications.commands), cause all of my Commands are available as Slash Commands too!**\n\n> Check out the [**Dashboard**](${websiteSettings.website.domain}/dashboard/${message.guild.id}) or the [**Live Music Queue**](${websiteSettings.website.domain}/queue/${message.guild.id})`)
